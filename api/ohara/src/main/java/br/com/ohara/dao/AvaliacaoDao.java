...
public interface AvaliacaoDao {
	...
	@SqlUpdate("INSERT INTO Avaliacao (idUsuario, idManga, nota) " + "VALUES (:idUsuario, :idManga, :nota)")
	...
	@SqlQuery("SELECT * FROM Avaliacao WHERE idManga = :idManga AND idUsuario = :idUsuario")
	Avaliacao consultarMinha(@Bind("idManga") Long idManga, @Bind("idUsuario") Long idUsuario);

	@SqlUpdate("UPDATE Avaliacao SET nota = :nota " + "WHERE idUsuario = :idUsuario and idManga = :idManga")
